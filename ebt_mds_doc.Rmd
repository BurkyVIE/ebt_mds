...
ebt_mds_full <-
  ...
  left_join(ebt_mds, by = "Date") %>% # und die Daten zu den Eingabezeitpunkten einfÃƒÂ¼gen.
...
# Immer englische AbkÃƒÂ¼rzungen fÃƒÂ¼r die Wochentage verwenden [wday() nimmt aus locale()]
