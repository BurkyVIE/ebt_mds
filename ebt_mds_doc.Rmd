...
The three longest active periods were:
...
```{r year1, echo=FALSE, message=FALSE, warning=FALSE, fig.width=7.5, fig.asp=1/sqrt(2)}
...
The seven most active months were:
...
The seven least active months were:
...
```{r month3, echo=FALSE, message=FALSE, warning=FALSE, fig.width=7.5, fig.asp=1/sqrt(2)}
...
```{r yearly, echo=FALSE, message=FALSE, warning=FALSE, fig.width=7.5, fig.asp=1/sqrt(2)}
...
```{r hits2, echo=FALSE, message=FALSE, warning=FALSE, fig.width=7.5, fig.asp=1/sqrt(2)}
