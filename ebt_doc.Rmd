...
Distribution of monthly number of Bills entered:

```{r month4, echo=FALSE, message=FALSE, warning=FALSE, fig.width=7, fig.asp=0.5625}

p <- ebt_grpd %>% 
  ggplot(mapping = aes(x = Count)) +
  geom_histogram(color = "white", fill = colors[5], binwidth = 750) +
  geom_freqpoly(binwidth = 750, color = colors[2], size = 1.1, linetype = "longdash") +
